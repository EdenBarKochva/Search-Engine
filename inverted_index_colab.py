...
class InvertedIndex:
    ...
    @staticmethod
    def read_csv(base_dir, name):
        return pd.read_csv(f'{base_dir}/{name}', compression='gzip',  engine='python')
    ...
    @staticmethod
    def write_a_posting_list(directory, b_w_pl):
    ...
    '''
        ...
        with closing(MultiFileWriter(directory, bucket)) as writer:
