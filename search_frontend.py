...
def search_body():
    ...
    if len(query) == 0:
        return jsonify(res)
    # BEGIN SOLUTION
    res = search_master.body_search(query=query)
    # END SOLUTION
    return jsonify(res)
...
def search_title():
    ...
    if len(query) == 0:
        return jsonify(res)
    # BEGIN SOLUTION
    res = search_master.get_relevant_titles(query)
    # END SOLUTION
    return jsonify(res)
...
def search_anchor():
    ...
    if len(query) == 0:
        return jsonify(res)
    # BEGIN SOLUTION
    res = search_master.get_relevant_anchors(query)
    # END SOLUTION
    return jsonify(res)
...
def get_pagerank():
    ...
    if len(wiki_ids) == 0:
        return jsonify(res)
    # BEGIN SOLUTION
    res = search_master.get_pagerank(wiki_ids)
    # END SOLUTION
    return jsonify(res)
...
def get_pageview():
    ...
    if len(wiki_ids) == 0:
        return jsonify(res)
    # BEGIN SOLUTION
    res = search_master.get_pageviews(wiki_ids)
    # END SOLUTION
    return jsonify(res)
